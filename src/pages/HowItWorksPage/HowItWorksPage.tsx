  ...
  return (
    <Box className='hiw-page-container'>
        ...
        <Box className='hiw-page-app-features-section-container'>
          ...
          <Typography variant="body1" mb={2}>
            <strong>Delete Journal Entry:</strong> If you select the trash can icon button on a journal entry card, a warning modal will pop up asking if you are sure you would like to delete the selected journal entry because this action is irreversible. If you a certain you would like to delete the entry, click the <i><strong>YES, I'M SURE</strong></i> button. Once your entry is successfully delete the warning modal will close and your dashboard will update to exclude the deleted entry. The <i><strong>CANCEL</strong></i> button will return you to your dashboard without deleting the entry.
          </Typography>
          <Typography variant="body1" mb={2}>
            <strong>Update Journal Entry:</strong> If you select the pencil icon button on a journal entry card, an <i><strong>Update Journal Entry</strong></i> form will pop up that looks like the <i><strong>Create Journal Entry</strong></i> form but will be repopulated with the information from the journal entry you selected. Make changes to the form and click the <i><strong>UPDATE</strong></i> button. Once your information has been successfully stored, a green success message will briefly flash to alert you of the successful changes and the form will close which will return you to your dashboard that will show your updated changes.  The <i><strong>CANCEL</strong></i> button will return you to your dashboard without updating the entry.
          </Typography>
        </Box>
