...
const MainPage:React.FC = () => {
  ...
  return (
    <Box className="landing-page-container">
      ...
      <Box className="landing-page-description-container" mt={4}>
