    ...
    <Box mb={2}>
      ...
      <LandingPageContainer mt={5} color="#6d0f93">
        <Box display="flex" justifyContent="center">
          <LandingPageDescriptionContainer px={2} py={2} borderRadius={10} minHeight={200} maxWidth={750}>
        ...
        <Box display="flex" justifyContent="center" mt={5}>
          ...
          <LandingPageDescriptionMiddleContainer px={2} py={2} borderRadius={10} minHeight={200} maxWidth={750} mt={2}>
        ...
        <Box display="flex" justifyContent="center" mt={5}>
          <LandingPageDescriptionContainer px={2} py={2} borderRadius={10} minHeight={200} maxWidth={750} mt={2}>
